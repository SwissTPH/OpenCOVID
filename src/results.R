...
run_results = function(o) {
  ...
  if (o$plot_scenarios == TRUE && length(single_scenarios) > 0) {
    ...
    # Alternative scenarios by layer of transmission
    fig_name = c("Alternative scenarios", "Layers")
    plot_temporal(o, fig_name, scenarios = single_scenarios, plot_by = "layer")
  ...
  if (o$plot_custom == TRUE && file.exists("manuscript.R"))
     plot_publication_figures(o)
}
