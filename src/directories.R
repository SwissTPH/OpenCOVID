...
set_dirs = function(o) {
  ...
  pth$calib_file = file.path(pth$config, "calibration_parameters.xlsx")
  pth$calib_mult = file.path(pth$config, "calibration_multipliers.csv")
  ...
  pth_output = file.path(pth$code, "output_v1")
