...
set_options = function(do_step = NA, test_param = NULL, quiet = FALSE) {
  ...
  # Load and format risk group properties
  o = format_risk_groups(o)
  
  # Load and format COVID-19 disease probabilities
  o = format_disease_probabilities(o)
  ...
  o$vaccine_effect = "mixed"  # OPTIONS: "transmission", "severity", or "mixed"
  ...
  o$transmission_blocking_scaler = 0.9
  o$disease_prevention_scaler    = 0.5
  ...
  o$vaccine_priority = c(group1 = 'age >= 75', 
                         group2 = '(age >= 65 & age < 75) | healthcare_worker == TRUE | comorbidities == TRUE', 
                         group3 = 'age >= 18 & age < 64')
  ...
  # Age-related distribution function for mass testing probability
  #
  # NOTES:
  #  1) Functional form as a string
  #  2) Include any necessary parameters
  #  3) No need for this to be normalised
  o$mass_testing_dist = "dunif(x)"  # eg: "dunif(x)" or "dgamma(x, 1.4)"
  ...
  o$acquisition_funcion = "expected_improvement"
  ...
  o$n_seeds_analysis = 40  # Not to be confused with 'n_seeds_emulator'
  ...
  o$plot_baseline     = TRUE  # Standard baseline calibration plots
  o$plot_future       = TRUE  # Future projection plots with any defined future scenarios
  o$plot_past         = TRUE  # Past evaluation plots with any defined past scenarios
  o$plot_strategies   = TRUE  # Plot results of any defined strategies
  ...
  o$plot_data_sources = TRUE  # Visualise the different data sources
  o$plot_emulator     = TRUE  # Plot emulator performance
  o$plot_parameters   = TRUE  # Parameter posterior plots
