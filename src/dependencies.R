...
packages = c("tidyverse",      # Includes ggplot2, dplyr, tidyr, and others (https://www.tidyverse.org/packages/)
             ...
             "rstatix",        # ANOVA analysis functionality
             ...
             "countrycode",    # Convert between country names and ISO codes
             ...
             "purrr",          # Vectorizing functions
             "tnet",           # Network analysis (weighted clustering coefficient)
             "igraph",         # Graph package
             "ggrepel")        # Plotting labels for ggplot         
